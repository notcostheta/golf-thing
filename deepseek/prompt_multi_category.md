Absolutely, if there are multiple categories for each event, we should include them as a list. Here's the updated concise prompt and structured JSON response to accommodate multiple categories:
